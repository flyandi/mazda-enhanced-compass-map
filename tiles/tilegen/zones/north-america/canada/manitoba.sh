...
./polytiles.py -p ../poly/north-america/canada/manitoba.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-canada-manitoba/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
