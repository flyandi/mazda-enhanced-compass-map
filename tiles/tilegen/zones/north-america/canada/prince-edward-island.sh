...
./polytiles.py -p ../poly/north-america/canada/prince-edward-island.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-canada-prince-edward-island/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
