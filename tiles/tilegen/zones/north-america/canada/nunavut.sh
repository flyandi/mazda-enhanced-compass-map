...
./polytiles.py -p ../poly/north-america/canada/nunavut.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-canada-nunavut/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
