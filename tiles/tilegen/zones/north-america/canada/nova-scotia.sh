...
./polytiles.py -p ../poly/north-america/canada/nova-scotia.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-canada-nova-scotia/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
