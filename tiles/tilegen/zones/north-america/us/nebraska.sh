...
./polytiles.py -p ../poly/north-america/us/nebraska.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-nebraska/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
