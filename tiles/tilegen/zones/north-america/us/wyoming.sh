...
./polytiles.py -p ../poly/north-america/us/wyoming.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-wyoming/ --zooms 11 11 --delete-empty --custom-fonts ../../../fonts/
...
7z a north-america-us-wyoming.7z .
