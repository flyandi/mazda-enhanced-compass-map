...
./polytiles.py -p ../poly/north-america/us/alabama.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-alabama/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
