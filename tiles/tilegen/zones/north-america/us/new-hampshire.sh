...
./polytiles.py -p ../poly/north-america/us/new-hampshire.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-new-hampshire/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
