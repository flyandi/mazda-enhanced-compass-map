...
./polytiles.py -p ../poly/north-america/us/district-of-columbia.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-district-of-columbia/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
