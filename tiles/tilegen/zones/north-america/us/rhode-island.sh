...
./polytiles.py -p ../poly/north-america/us/rhode-island.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-rhode-island/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
