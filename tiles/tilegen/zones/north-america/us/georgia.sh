...
./polytiles.py -p ../poly/north-america/us/georgia.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-georgia/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
