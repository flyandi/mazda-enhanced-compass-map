...
./polytiles.py -p ../poly/north-america/us/vermont.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-vermont/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
