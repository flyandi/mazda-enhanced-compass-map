...
./polytiles.py -p ../poly/north-america/us/michigan.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-michigan/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
