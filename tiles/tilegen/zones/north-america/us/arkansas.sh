...
./polytiles.py -p ../poly/north-america/us/arkansas.poly -s ../../tilestyles/mazda/mazda.xml -t ../../../output/north-america-us-arkansas/ --zooms 0 11 --delete-empty --custom-fonts ../../../fonts/
