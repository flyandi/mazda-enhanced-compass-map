...
.route.line[highway='service'] {
  ...
  [zoom=16]{ line-width:2; line-opacity:0.8; }
  [zoom=17]{ line-width:4 + 2 + @zoom; }
...
.route.tunnel[highway='motorway_link'] {
  ...
  [zoom=16]{ line-width:5.5 + 2; }
  [zoom=17]{ line-width:6 + 2.5+ @zoom; }
  [zoom>17]{ line-width:14 + 2.5; }
}

/*
.route.bridge::b[highway='motorway_link'] {
  [zoom>9] { line-color:darken(@motorway_line,1); line-cap:butt; line-join:round; }
...
.route.bridge::b[highway='trunk_link'] {
  [zoom>9] { line-color:darken(@trunk_line,1); line-cap:butt; line-join:round; }
  [zoom=10]{ line-width:0.8 + 1; }
  [zoom=11]{ line-width:1; }
  [zoom=12]{ line-width:1.0 + 2; }
  [zoom=13]{ line-width:1.2 + 2; }
...
.route.bridge::b[highway='primary_link'] {
  [zoom>9] { line-color:darken(@primary_line,1); line-cap:butt; line-join:round; }
  [zoom=10]{ line-width:0.8 + 1; }
  [zoom=11]{ line-width:1; }
  [zoom=12]{ line-width:1.0 + 2; }
  [zoom=13]{ line-width:1.2 + 2; }
...
.route.bridge::b[highway='secondary_link'] {
  [zoom>9] { line-color:darken(@secondary_line,1); line-cap:butt; line-join:round; }
...
.route.line[highway='unclassified'] {
  [zoom>=15] { line-color:@road_line; line-cap:round; line-join:round; }
  [zoom=15]{ line-width:3.5 + 2; }
  [zoom=16]{ line-width:6 + 2; }
  [zoom=17]{ line-width:6 + 2+ @zoom; }
...
.route.bridge::b[highway='unclassified'] {
  [zoom>9] { line-color:spin(darken(@road_line,1),-1); line-cap:butt; line-join:round; }
...
.route.fill[highway='unclassified'] {
  ...
  [zoom>=13]{ line-width:1.0;line-opacity:0.5; }
  [zoom=15]{ line-width:3.5;line-opacity:1; }
  [zoom=16]{ line-width:6;line-opacity:1;  }
  [zoom=17]{ line-width:8+ @zoom;line-opacity:1;  }
  [zoom>17]{ line-width:10;line-opacity:1;  }
}

/* Secondary */
.route.line[highway='secondary'][tunnel='no'],
.route.tunnel[highway='secondary'] {
  [zoom>10] { line-color:@secondary_line; line-cap:round; line-join:round; }
  ...
  [zoom=11]{ line-width:0.9; line-opacity:0.5; }
  [zoom=12]{ line-width:0.9 + 2; }
  [zoom=13]{ line-width:1.2 + 4; }
...
.route.bridge::b[highway='secondary'] {
  [zoom>7] { line-color:spin(darken(@road_line,1),-1); line-cap:butt; line-join:round; }
  [zoom=8] { line-width:0.3; }
  [zoom=9] { line-width:0.5; }
  [zoom=10]{ line-width:0.7; }
  [zoom=11]{ line-width:0.9; }
  [zoom>11]{ line-color:spin(darken(@secondary_line,1),-1); }
  [zoom=12]{ line-width:0.9 + 2; }
  [zoom=13]{ line-width:1.2 + 2; }
  [zoom=14]{ line-width:2.6 + 2; }
  [zoom=15]{ line-width:4 + 2; }
...
.route.tunnel[highway='primary'] {
  ...
  [zoom=11]{ line-width:3.0; line-opacity:0.2;}
  [zoom=12]{ line-width:1.0 + 2; }
  [zoom=13]{ line-width:1.4 + 5; }
  [zoom=14]{ line-width:3 + 2; }
  [zoom=15]{ line-width:5 + 2; }
  [zoom=16]{ line-width:7 + 2.5; }
  [zoom=17]{ line-width:9 + 3+ @zoom; }
  [zoom>17]{ line-width:18 + 3; }
}
/*
.route.bridge::b[highway='primary'] {
  [zoom>6] { line-color:spin(darken(@primary_line,1),-1); line-cap:butt; line-join:round; }
...
.route.fill[highway='primary'] {
  ...
  [zoom=11]{ line-width:2.0; line-opacity:0.2; }
  [zoom=12]{ line-width:1.0; }
  [zoom=13]{ line-width:1.4 + 3; }
  [zoom=14]{ line-width:3; }
  [zoom=15]{ line-width:5; }
  [zoom=16]{ line-width:7; }
  [zoom=17]{ line-width:9+ @zoom; }
...
.turning-circle[zoom>=14] {
  ...
  [zoom=17] { marker-width: 9+ @zoom; }
  [zoom>17] { marker-width: 12; marker-line-width: 1.5; }
}

/* ---- ONE WAY ARROWS ---- */
/* TODO: oneway='-1' */
.highway-label::arrow[oneway='yes'][zoom>20] {
  marker-type:arrow;
  marker-line-width:1;
...
/* ---- PARKING ---- */
.parking[zoom>13] {
  polygon-fill:lighten(@parking,3);
  line-color:darken(@parking,6);
